...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        unit1=(Button)rootView.findViewById(R.id.unit1);
        unit1.setOnClickListener(new DrawLisenner());
        unit2=(Button)rootView.findViewById(R.id.unit2);
        unit2.setOnClickListener(new DrawLisenner());
        unit3=(Button)rootView.findViewById(R.id.unit3);
        unit3.setOnClickListener(new DrawLisenner());
        unit4=(Button)rootView.findViewById(R.id.unit4);
        unit4.setOnClickListener(new DrawLisenner());
        unit5=(Button)rootView.findViewById(R.id.unit5);
        unit5.setOnClickListener(new DrawLisenner());
        unit6=(Button)rootView.findViewById(R.id.unit6);
        unit6.setOnClickListener(new DrawLisenner());
        unit7=(Button)rootView.findViewById(R.id.unit7);
        unit7.setOnClickListener(new DrawLisenner());
        unit8=(Button)rootView.findViewById(R.id.unit8);
