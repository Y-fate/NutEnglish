...
public class Maindraw extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
	{
		...
		unit1=(Button)this.findViewById(R.id.unit1);
		unit1.setOnClickListener(new DrawLisenner());
		unit2=(Button)this.findViewById(R.id.unit2);
		unit2.setOnClickListener(new DrawLisenner());
		unit3=(Button)this.findViewById(R.id.unit3);
		unit3.setOnClickListener(new DrawLisenner());
		unit4=(Button)this.findViewById(R.id.unit4);
		unit4.setOnClickListener(new DrawLisenner());
		unit5=(Button)this.findViewById(R.id.unit5);
		unit5.setOnClickListener(new DrawLisenner());
		unit6=(Button)this.findViewById(R.id.unit6);
		unit6.setOnClickListener(new DrawLisenner());
		unit7=(Button)this.findViewById(R.id.unit7);
		unit7.setOnClickListener(new DrawLisenner());
		unit8=(Button)this.findViewById(R.id.unit8);
		unit8.setOnClickListener(new DrawLisenner());
		drawMainText=(TextView)this.findViewById(R.id.drawTextView1);
		drawTextN=(TextView)this.findViewById(R.id.drawTextViewN);
		seacherButton=(ImageView)this.findViewById(R.id.drawButton1);
		seacherButton.setOnClickListener(new DrawLisenner());
		drawflash=(ImageView)this.findViewById(R.id.drawFlashImg);
		drawflash.setOnClickListener(new DrawLisenner());
		eText=(EditText)this.findViewById(R.id.drawEditText1);
		flashEnglish();
...
public void myToast(String string){
	Toast atoast;
	atoast=Toast.makeText(Maindraw.this,string,Toast.LENGTH_SHORT);
	...
	public void jumpActivity( int jumpPager){
				...
				intent.setClass(Maindraw.this, Picture.class);
				intent.putExtra("picture",jumpPager);
				startActivity(intent);	
	}
	public class DrawLisenner implements OnClickListener
	{
		...
		public void onClick(View p1)
		{
			...
			else if(p1.getId()==R.id.unit3){
				jumpActivity(20);
			}
			else if(p1.getId()==R.id.unit4){
				jumpActivity(30);
			}
			else if(p1.getId()==R.id.unit5){
				jumpActivity(40);
			}
			else if(p1.getId()==R.id.unit6){
				jumpActivity(50);
			}
			else if(p1.getId()==R.id.unit7){
				jumpActivity(60);
			}
			else if(p1.getId()==R.id.unit8){
				jumpActivity(70);
			}
			else if(p1.getId()==R.id.drawFlashImg){
